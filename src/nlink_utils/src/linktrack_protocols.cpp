...
NLT_ProtocolNodeFrame7::NLT_ProtocolNodeFrame7()
    : NLinkProtocolVLength(
          true, g_nlt_nodeframe7.fixed_part_size,
          {g_nlt_nodeframe7.frame_header, g_nlt_nodeframe7.function_mark}) {}

void NLT_ProtocolNodeFrame7::UnpackFrameData(const uint8_t *data) {
  g_nlt_nodeframe7.UnpackData(data, length());
}
