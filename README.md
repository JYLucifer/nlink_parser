...
<h1 align="center">NLink Parser ROS2 Package</h1>

<div align="center">

![Logo](./image/nooploop.png)

本ROS2包用于支持Nooploop产品，采用C++编写，只需根据对应产品手册，通过我们的上位机NAssistant配置好模块，确定设备已正常工作后，运行本ROS2包中产品对应的节点即可获取产品协议一一对应的ROS2消息，为您省去处理数据通信及解析的时间
...
- [Submodule](#submodule)
  - [nlink\_utils/nlink\_unpack](#nlink_utilsnlink_unpack)
  - [nlink\_utils/protocol\_extracter](#nlink_utilsprotocol_extracter)
- [License](#license)
...
参数
   - **`port_name`** 设备串行端口名称，默认值: `/dev/ttyCH343USB0`.
...
* **`/nlink_linktrack_data_transmission`** ([std_msgs::msg::String])

	你可以通过对该话题发布消息，将数据发送给LinkTrack节点，进而利用数传功能

发布的话题

  - **`/nlink_linktrack_anchorframe0`** ([nlink_parser2::msg::LinktrackAnchorframe0])
  - **`/nlink_linktrack_tagframe0`** ([nlink_parser2::msg::LinktrackTagframe0])
  - **`/nlink_linktrack_nodeframe0`** ([nlink_parser2::msg::LinktrackNodeframe0])
  - **`/nlink_linktrack_nodeframe1`** ([nlink_parser2::msg::LinktrackNodeframe1])
  - **`/nlink_linktrack_nodeframe2`** ([nlink_parser2::msg::LinktrackNodeframe2])
  - **`/nlink_linktrack_nodeframe3`** ([nlink_parser2::msg::LinktrackNodeframe3])
  - **`/nlink_linktrack_nodeframe4`** ([nlink_parser2::msg::LinktrackNodeframe4])
  - **`/nlink_linktrack_nodeframe5`** ([nlink_parser2::msg::LinktrackNodeframe5])
  - **`/nlink_linktrack_nodeframe6`** ([nlink_parser2::msg::LinktrackNodeframe6])
  - **`/nlink_linktrack_nodeframe7`** ([nlink_parser2::msg::LinktrackNodeframe7])
...
发布的话题
  ...
  - **`/nlink_linktrack_nodeframe0`** ([nlink_parser2::msg::LinktrackNodeframe0])
  - **`/nlink_linktrack_aoa_nodeframe0`** ([nlink_parser2::msg::LinktrackAoaNodeframe0])
...
发布的话题
  ...
  - **`/nlink_tofsense_cascade`** ([nlink_parser2::msg::TofsenseCascade]) 
  - **`/nlink_tofsense_frame0`** ([nlink_parser2::msg::TofsenseFrame0])
...
发布的话题
  ...
  - **`/nlink_tofsensem_frame0`** ([nlink_parser2::msg::TofsenseMFrame0])


## How to Subscribe Our Topic

参考 [nlink_example2](https://github.com/nooploop-dev/nlink_example2)，在您的ROS包中订阅我们的话题

## Submodule

### [nlink_utils/nlink_unpack](https://github.com/nooploop-dev/nlink_unpack)
...
### [nlink_utils/protocol_extracter](https://github.com/nooploop-dev/protocol_extracter) 
...
问题反馈及功能建议请使用 [Issue Tracker](https://github.com/nooploop-dev/nlink_parser2/issues).
